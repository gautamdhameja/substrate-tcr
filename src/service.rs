...
use futures::prelude::*;
use substrate_tcr_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	substrate_tcr_runtime::api::dispatch,
	substrate_tcr_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			substrate_tcr_runtime::opaque::Block, substrate_tcr_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, substrate_tcr_runtime::RuntimeApi, _, _>(
